  ...
  navMenus: [
    {
      ...
      items: [
        ...
        { id: "verify", href: "/dashboard/verify", label: "KRL Verify", desc: "파일 해시 · 진위 검증", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", visible: true },
        { id: "room", href: "/room", label: "KRL Room", desc: "즉석 협업 공간 · 로그인 없이", icon: "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10", visible: true },
        { id: "ghost", href: "/dashboard/ghost", label: "KRL Ghost", desc: "익명 피드백 박스", icon: "M12 2a9 9 0 0 1 9 9c0 4.97-9 13-9 13S3 15.97 3 11a9 9 0 0 1 9-9z M12 7v5 M12 16h.01", visible: true },
        ...
        { id: "assets", href: "/dashboard/assets", label: "KRL Assets", desc: "파일 업로드 → 즉시 CDN URL (cdn.krl.kr)", icon: "M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12", visible: true },
        { id: "countdown", href: "/dashboard/countdown", label: "KRL Countdown", desc: "시험·행사·출시일 카운트다운", icon: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2", visible: true },
        { id: "waitlist", href: "/dashboard/waitlist", label: "KRL Waitlist", desc: "대기자 명단 · 이메일 수집 · 추천인", icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8 M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75", visible: true },
        { id: "guestbook", href: "/dashboard/guestbook", label: "KRL Guestbook", desc: "방명록 페이지 · embed 위젯", icon: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z", visible: true },
        { id: "launchpad", href: "/dashboard/launchpad", label: "KRL Launchpad", desc: "사이드 프로젝트 런치패드", icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z", visible: true },
        { id: "patch", href: "/dashboard/patch", label: "KRL Patch", desc: "긴급 공지 배너 embed", icon: "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z M12 9v4 M12 17h.01", visible: true },
        { id: "receipt", href: "/dashboard/receipt", label: "KRL Receipt", desc: "영수증 · 인보이스 생성기", icon: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8", visible: true },
        { id: "snapshot", href: "/dashboard/snapshot", label: "KRL Snapshot", desc: "웹사이트 스크린샷 API", icon: "M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z M12 17a4 4 0 1 0 0-8 4 4 0 0 0 0 8z", visible: true },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: "badge", href: "/dashboard/badge", label: "배지 생성기", desc: "GitHub README SVG 배지", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", visible: true },
        { id: "og-image", href: "/dashboard/og", label: "OG 이미지", desc: "소셜 공유 썸네일 생성", icon: "M4 5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H4z M9 9h6 M9 12h4", visible: true },
        { id: "signature", href: "/dashboard/signature", label: "이메일 서명", desc: "HTML 이메일 서명 생성기", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", visible: true },
        { id: "fonts", href: "/dashboard/fonts", label: "폰트 CDN", desc: "무료 웹폰트 CDN · Google Fonts", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", visible: true },
      ],
    },
  ],
  simpleLinks: [
