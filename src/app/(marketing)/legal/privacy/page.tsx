    ...
    <div className="section" style={{ paddingTop: "60px" }}>
      <div className="container" style={{ maxWidth: "760px" }}>
        ...
        <Section title="제3조 (개인정보의 제3자 제공)">
          <p>
            <strong>회사는 이용자의 개인정보를 제3자에게 판매하거나 임의로 제공하지 않습니다.</strong>
            원칙적으로 외부에 제공하지 않으며, 다음의 경우에만 예외적으로 제공합니다:
          </p>
          <ul style={{ paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
            <li>이용자가 사전에 동의한 경우</li>
            <li>법령에 따라 수사기관의 요청이 있는 경우</li>
            <li>서비스 제공을 위해 반드시 필요한 업무를 수행하는 수탁 업체에 처리를 위탁하는 경우 (제4조 참고)</li>
          </ul>
        </Section>
