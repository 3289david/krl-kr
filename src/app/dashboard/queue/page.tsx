        ...
        {selected ? (
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18, flexWrap: "wrap" }}>
              ...
              <a href={`https://krl.kr/qr/${selected.slug}`} target="_blank" rel="noopener" style={{ padding: "6px 14px", border: "1px solid var(--color-hairline)", borderRadius: 8, color: "var(--color-body)", textDecoration: "none", fontSize: ".8125rem" }}>QR 코드</a>
