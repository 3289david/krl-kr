  ...
  return (
    <div style={{ padding: "32px" }}>
      ...
      <div style={{ padding: "14px 18px", background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: "var(--radius-md)", marginBottom: "20px", fontSize: "0.8125rem", color: "#1e40af", lineHeight: 1.6 }}>
        ...
        • <strong>A 레코드</strong>: IPv4 서버로 직접 라우팅 (Cloudflare SSL 자동 처리) 예: <code>1.2.3.4</code><br />
        • <strong>AAAA 레코드</strong>: IPv6 서버로 직접 라우팅 (Cloudflare SSL 자동 처리) 예: <code>2001:db8::1</code><br />
        • <strong>CNAME</strong>: 커스텀 호스트명으로 라우팅 (Cloudflare SSL 자동 처리) 예: <code>example.com</code><br />
