...
import {
  ...
  SettingsIcon, KeyIcon, FileIcon, CodeIcon,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SidebarLink href="/dashboard/analytics" icon={<BarChartIcon size={17} />} label="분석" />
        ...
        >
          ...
          <p
            style={{ fontSize: "0.75rem", color: "var(--color-muted)", marginBottom: "12px" }}
          >
            무제한 링크, 고급 분석, 커스텀 도메인
          </p>
          <Link
            href="/pricing"
            className="btn btn-primary btn-sm btn-pill"
            style={{ textDecoration: "none", justifyContent: "center", width: "100%", fontSize: "0.8125rem" }}
          >
            업그레이드
          </Link>
        </div>
